...
# import mygan
# import architectures.dcganBatchNorm as DBN
#
...
#         self.type = type
#         cProblem = {"nc" : problem.nc + 1, "nf" : problem.nf}
#         self.dcgan = DBN.DiscEcal(type, hyper, cProblem)
#         self.l1 = nn.Linear(problem.nz, nf)
